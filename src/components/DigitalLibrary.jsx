  ...
  return (
    <div className="space-y-6">
      ...
      <section className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex items-center gap-5 text-left relative overflow-hidden">
        ...
        <div>
          <h2 className="text-2xl font-black text-slate-900 dark:text-white leading-tight">Biblioteca Digital</h2>
          <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 mt-1">Repositorio estructurado de guías didácticas, lecturas y recursos educativos.</p>
        </div>
      </section>
